...
3. Run for local mapping <code> docker run -it -v /home/datademon/Desktop/Alik/galax_spip_v2/data:/data image-name /bin/sh -c "bin/opensfm_run_all /data/{mission_name}-{flight_num}-{frame_number}"   
